...
export async function createReservationAction(
  ...
  const result = await createReservation({
    ...
    cin_delivered_le: String(formData.get("cin_delivered_le") || "").trim() || null,
    ...
    passport_delivered_le: String(formData.get("passport_delivered_le") || "").trim(),
    ...
    second_driver_date_naissance: String(formData.get("second_driver_date_naissance") || "").trim() || null,
    ...
    second_driver_cin_delivered_le: String(formData.get("second_driver_cin_delivered_le") || "").trim() || null,
    ...
    second_driver_passport_delivered_le: String(formData.get("second_driver_passport_delivered_le") || "").trim() || null,
